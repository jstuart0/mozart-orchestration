...
Which stage(s) does this agent run, and in which pipeline shape? DELIVER uses stage numbers 1–13 (plus 2b and 12b); the other shapes are AUDIT, DIAGNOSE, OPERATE, INCIDENT and EVAL. Is it a reviewer (DELIVER stage 4), a mid-build specialist (DELIVER stage 8), or something else?
