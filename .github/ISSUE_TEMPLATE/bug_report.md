...
Which agent was running when the problem occurred (mozart, harry, jackson, valerie, etc.)? Which pipeline shape (DELIVER / AUDIT / DIAGNOSE)? Which stage number (1–13, 2b, or 12b)?
