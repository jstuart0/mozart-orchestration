...
| `TICKETS.md` | The ticket lifecycle — project resolution, existing-ticket detection, per-phase comments, state transitions | before resolving a ticketing project, creating a ticket, or posting a phase comment |
